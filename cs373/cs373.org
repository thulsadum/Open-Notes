...
*** Algorithm
    Is G \Rightarrow^{ \star } w true or false?
...
** Formal Definition of CSG and Non-Contracting Grammars
   G = (V, \Sigma, R, S)

   1) V is finite set of _variables_
   2) \Sigma  is a finite set of _terminals_ and \Sigma \cap V =
      \emptyset
   3) 
...
** Normal Form Definition
   ...
   5) One additional rule allowed S \rightarrow \epsilon and S is not
