...
\item Take c$_1$ and c$_2$ s.t.: 
        ...
        c_2
        \end{array} \right )$
\item Notice this is only solvable iff $W(y_1,y_2)_{t=t_0} \neq 0$
\item Theorm: If u and v solve $y'' + p(t)y' + g(t)y = 0$ then
        W(u,v)=0 for all t or W is never 0
\end{itemize}
\end{itemize} % ends low level
\end{itemize} % ends low level
\subsection{Second Order Homogenous Eq}
\label{sec-9.2}
